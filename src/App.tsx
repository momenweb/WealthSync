    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white overflow-x-hidden">
      ...
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div
            className="absolute top-1/4 -right-1/4 w-[300px] h-[300px] sm:w-[600px] sm:h-[600px] bg-amber-500/10 rounded-full blur-3xl animate-pulse-slow"
            style={{ transform: `translateY(${scrollY * 0.3}px)` }}
          />
          <div
            className="absolute -top-1/4 -left-1/4 w-[400px] h-[400px] sm:w-[800px] sm:h-[800px] bg-blue-500/5 rounded-full blur-3xl animate-pulse-slow"
            style={{ transform: `translateY(${scrollY * 0.2}px)` }}
          />
          <div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] sm:w-[400px] sm:h-[400px] bg-emerald-500/5 rounded-full blur-3xl"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-amber-500/10 border border-amber-500/30 rounded-full text-xs sm:text-sm text-amber-400 font-medium">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-slate-300 leading-relaxed max-w-lg">
                WealthSync™️ revolutionizes wealth management by combining AI-powered insights, 
                automated client communication, and real-time portfolio monitoring in one seamless platform.
              </p>

              {/* Hero Stats */}
              <div className="grid grid-cols-3 gap-3 sm:gap-6 py-4 sm:py-6">
                <div className="text-center">
                  <div className="text-lg sm:text-2xl font-bold text-amber-400">500+</div>
                  <div className="text-xs sm:text-sm text-slate-400">Financial Advisors</div>
                </div>
                <div className="text-center">
                  <div className="text-lg sm:text-2xl font-bold text-emerald-400">$2.5B+</div>
                  <div className="text-xs sm:text-sm text-slate-400">Assets Under Management</div>
                </div>
                <div className="text-center">
                  <div className="text-lg sm:text-2xl font-bold text-blue-400">98%</div>
                  <div className="text-xs sm:text-sm text-slate-400">Client Satisfaction</div>
                </div>
              </div>

              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button className="group px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-amber-400 to-amber-600 text-slate-950 font-semibold rounded-lg hover:shadow-2xl hover:shadow-amber-500/50 transition-all duration-300 flex items-center justify-center gap-2 text-sm sm:text-base">
                  Start Free Trial
                  <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" />
                </button>
                <button className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-amber-500/30 text-white font-semibold rounded-lg hover:border-amber-500/60 hover:bg-amber-500/5 transition-all duration-300 flex items-center justify-center gap-2 text-sm sm:text-base">
              ...
              {/* Trust Indicators */}
              <div className="pt-4">
                <p className="text-xs sm:text-sm text-slate-400 mb-3">Trusted by leading financial institutions</p>
                <div className="flex items-center gap-3 sm:gap-6 opacity-60 flex-wrap">
                  <div className="w-16 h-6 sm:w-20 sm:h-8 bg-slate-700 rounded flex items-center justify-center text-xs font-medium">Goldman Sachs</div>
                  <div className="w-16 h-6 sm:w-20 sm:h-8 bg-slate-700 rounded flex items-center justify-center text-xs font-medium">Morgan Stanley</div>
                  <div className="w-16 h-6 sm:w-20 sm:h-8 bg-slate-700 rounded flex items-center justify-center text-xs font-medium">JP Morgan</div>
                </div>
              </div>
            </div>
